...
//public class CourseEntityWriteService(ContosoContext dbContext, IEntityReadService<Course, int, CourseSearchObject> readService, IEnumerable<IEntityPrepper<Course, int>> preppers)
