...
4. If `AGENTS.md` is missing, ask the user to copy `ai/consumer.agents.stub.md` from Regira-Codebase into the repository root.
...
After you copy this file to `.github/copilot-instructions.md`, the sync script replaces that destination with a rendered Copilot bootstrap that lists the exact guide paths for the selected modules.