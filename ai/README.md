...
Six project templates (`ConsoleWithLogging`, `BasicApi`, `SelfHostingApi`, `SelfHostingApiWithAuth`, etc.) ensure generated code lands in the right architectural shape before any module code is written.
