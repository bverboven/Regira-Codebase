...
1. [Examples](docs/examples.md) — Backend swap, transform & re-upload, GitHub→Azure mirror, ZIP export, safe upload
1. [Compression](docs/compression.md) — Password-protected ZIP via SharpZipLib
