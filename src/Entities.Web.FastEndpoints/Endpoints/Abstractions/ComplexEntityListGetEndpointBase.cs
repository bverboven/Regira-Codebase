...
/// <summary>
/// Base endpoint for listing entities with sort/includes support: <c>GET {BaseRoute}</c>.
/// <para>
...
/// </para>
/// </summary>
public abstract class ComplexEntityListGetEndpointBase<TEntity, TKey, TSo, TSortBy, TIncludes, TDto>
    : Endpoint<TSo, ListResult<TDto>>
...
/// </summary>
public abstract class ComplexEntityListGetEndpointBase<TEntity, TSo, TSortBy, TIncludes, TDto>
    : ComplexEntityListGetEndpointBase<TEntity, int, TSo, TSortBy, TIncludes, TDto>
