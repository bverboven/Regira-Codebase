...
/// <summary>
/// Base endpoint for creating a new entity: <c>POST {BaseRoute}</c>.
/// <para>
/// The input DTO is expected to produce a new (default-key) entity after mapping.
/// </para>
/// </summary>
public abstract class EntityCreateEndpointBase<TEntity, TKey, TDto, TInputDto>
...
/// </summary>
public abstract class EntityCreateEndpointBase<TEntity, TDto, TInputDto>
    : EntityCreateEndpointBase<TEntity, int, TDto, TInputDto>
