...
/// <summary>
/// Base endpoint for searching entities (list + count) with sort/includes support using a
/// body array of search objects: <c>POST {BaseRoute}/search</c>.
/// <para>
...
/// </para>
/// </summary>
public abstract class ComplexEntitySearchPostEndpointBase<TEntity, TKey, TSo, TSortBy, TIncludes, TDto>
    : EndpointWithoutRequest<SearchResult<TDto>>
...
/// </summary>
public abstract class ComplexEntitySearchPostEndpointBase<TEntity, TSo, TSortBy, TIncludes, TDto>
    : ComplexEntitySearchPostEndpointBase<TEntity, int, TSo, TSortBy, TIncludes, TDto>
