...
1. **[Index](01-index.md)** — Overview, interface, models, and configuration reference
1. [Examples](02-examples.md) — Simple send, attachments & multiple recipients, backend swap, Identity integration
